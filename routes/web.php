...
Route::get('favorited/{id}', 'AnimeController@storeFavorite')->name('favorited')->middleware('auth');
Route::get('/favorites', 'AnimeController@showfavorites')->name('favorites')->middleware('auth');
